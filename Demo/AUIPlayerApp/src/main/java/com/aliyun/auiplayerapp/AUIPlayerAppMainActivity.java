...
public class AUIPlayerAppMainActivity extends AUIPlayerBaseListActivity {
    ...
    private void initSettingView() {
        AUIPlayerActionBar mAUIPlayerActionBar = findViewById(R.id.aui_player_base_title);
        ...
        mAUIPlayerActionBar.setOnsettingClickListener(new AUIPlayerActionBar.OnSettingClickListener() {
            ...
            public void onsettingClick() {
                Intent settingView = new Intent(AUIPlayerAppMainActivity.this, AUIBackstageActivity.class);
    ...
    private void onModelItemClick(ListModel model) {
        switch (model.index) {
            ...
            case INDEX_SHORT_VIDEO_LIST: {
                AUIShortVideoListUtil.requestVideoInfoList(AUIShortVideoListConstants.DEFAULT_VIDEO_ID, new AUIShortVideoListUtil.OnNetworkCallBack<List<VideoInfo>>() {
                    @Override
                    public void onResponse(List<VideoInfo> data) {
                        ...
                        intent.putExtra(AUIShortVideoListView.KEY_VIDEO_INFO_LIST_DATA, videoListJSON);
                        startActivity(intent);
                    }
                });
                break;
